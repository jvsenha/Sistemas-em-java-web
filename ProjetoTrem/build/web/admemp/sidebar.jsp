    ...
    <body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="search-bar input-group">
                            <button class="btn btn-link"  >
                                 <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/LogoutAdmEmp"><i class="bi bi-box-arrow-right"></i></a>
                            </button>
                        </li>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    <li>
                        <a href="${pageContext.request.contextPath}/admemp/dashboard.jsp">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/ListarTremAdmEmp?idUsuario=${usuario}">
                           <i class="bi bi-train-freight-front-fill"></i>
                            <p>Lista de trems</p>
                        </a>
                    </li>
                      <li>
                        <a href="${pageContext.request.contextPath}/admemp/cadastrartrem.jsp">
                            <i class="bi bi-train-freight-front-fill"></i>
                            <p>Cadastrar Trem</p>
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/ListarPro">
                        <i class="bi bi-bag-plus-fill"></i>
                            <p>Cadastrar Produto</p>
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/ListarProdEmp?idUsuario=${usuario}">
                         <i class="bi bi-bag-fill"></i>
                            <p>listar Produto</p>
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/DadosMaq">
                          <i class="bi bi-person-plus-fill"></i>
                            <p>Cadastrar Maquinista</p>
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/ListarMaqEmp?idUsuario=${usuario}">
                         <i class="bi bi-person-lines-fill"></i>
                            <p>Listar Maquinista</p>
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/admemp/cadastrarempresa.jsp">
                         <i class="bi bi-globe-americas"></i>
                            <p>Cadastrar Viagem</p>
                        </a>
                        <a href="${pageContext.request.contextPath}/admemp/listarmaquinista.jsp">
                         <i class="bi bi-globe-americas"></i>
                            <p>Cadastrar Viagem</p>
                        </a>
                    </li>
