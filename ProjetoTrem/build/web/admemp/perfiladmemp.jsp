                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal form-material mx-2" name="alteraradministrador" action="AlterarAdm" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="Nome" class="form-control form-control-line" value="${administrador.nomeUsuario}"  name="nomeAdmempresa" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="email" placeholder="Email" class="form-control form-control-line" value="${administrador.emailUsuario}" name="emailAdmempresa" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="number" placeholder="Telefone" class="form-control form-control-line" value="${administrador.telUsuario}" name="telAdmempresa" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="Login" class="form-control form-control-line" value="${administrador.loginUsuario}"  name="loginAdmempresa" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="Senha" class="form-control form-control-line" value="${administrador.senhaUsuario}" name="senhaAdmempresa" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control form-control-line" value="${administrador.cidadeUsuario}" name="cidadeAdmempresa" >
                                            </div>
                                        </div>
