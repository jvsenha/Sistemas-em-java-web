                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal form-material mx-2" name="alteraradministrador" action="AlterarAdm" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="Nome" class="form-control form-control-line" value="${administrador.nomeUsuario}"  name="nomeAdm" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="email" placeholder="Email" class="form-control form-control-line" value="${administrador.emailUsuario}" name="emailAdm" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="number" placeholder="Telefone" class="form-control form-control-line" value="${administrador.telUsuario}" name="telAdm" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="Login" class="form-control form-control-line" value="${administrador.loginUsuario}"  name="loginAdm" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="Senha" class="form-control form-control-line" value="${administrador.senhaUsuario}" name="senhaAdm" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control form-control-line" value="${administrador.cidadeUsuario}" name="cidadeAdm" >
                                            </div>
                                        </div>
