...
import br.com.projetotrem.dao.UsuarioDAOImpl;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (dao.ativar(usuario)) {
                    menssagem = "usuario ativado com sucesso.";
                    request.setAttribute("menssagem", menssagem);
                    request.getRequestDispatcher("SolicitacaoAdmSis").forward(request, response);
                } else {
                    menssagem = "Problemas ao inativar usuario.";
                    request.setAttribute("menssagem", menssagem);
                    request.getRequestDispatcher("SolicitacaoAdmSis").forward(request, response);
                }
            } catch (Exception e) {
