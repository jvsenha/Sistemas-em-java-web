...
<html lang="en">
    ...
    <body class="text-center cadastrar" style="background-color: #efefef">
        ...
        <div class="col-5" style="margin: 10%;">
            <form class="form-signin" action="${pageContext.request.contextPath}/LoginMaquinista" method="POST">
                <img class="mb-4" src="${pageContext.request.contextPath}/css/assets/img/motorista.png" alt="" width="150" height="150">
                <h1 class="h3 mb-3 font-weight-normal">Login Maquinista</h1>
                <h6 class=" mb-3 font-weight-normal" style="color: #000"><b>${mensagem}</b></h6>

                <label for="inputEmail" class="sr-only">Email address</label>
                <input type="text" class="form-control m-3" style="color:black;" placeholder="Login" name="loginMaq" required autofocus>
                <label for="inputPassword" class="sr-only">Password</label>
                <input type="password" id="inputPassword" style="color:black;" class="form-control m-3 " placeholder="Senha"  name="senhaMaq" required>
