            ...
            <div class="container-fluid ">
                <div class="row tabela">
                    ...
                    <table class=" table    ">
                        ...
                        <tbody>
                            <tr>
                                <c:forEach var="terminal" items="${terminais}">

                                <tr>
                                    <th align="center">${terminal.nomeTerm}</th>
                                    <th align="center">${terminal.longTerm}</th>
                                    <th align="center">${terminal.latTerm}</th>
                                </tr>
