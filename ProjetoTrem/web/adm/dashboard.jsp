            ...
            <div class="main-panel">
                ...
                <div class="content">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                                                <label class="btn btn-sm btn-primary btn-simple active" id="0">
                                                    ...
                                                    <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Acidentes</span>
                                                ...
                                                <label class="btn btn-sm btn-primary btn-simple" id="1">
                                                    ...
                                                    <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Combustíveis</span>
                                                    <span class="d-block d-sm-none">
                                                ...
                                                <label class="btn btn-sm btn-primary btn-simple" id="2">
                                                    ...
                                                    <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Sei la</span>
                                                    <span class="d-block d-sm-none">
                    ...
                    <div class="row">
                      <div class="col-lg-6 col-md-12">
                            <div class="card ">
                                ...
                                <div class="card-body">
                                    <a href="${pageContext.request.contextPath}/adm/cadastrarproduto.jsp">
                                        <i class="bi bi-bag-plus-fill mr-2" style="float: left;"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12" style="margin-top: -135px;">
                            <div class="card ">
