...
<html lang="en">
    ...
    <body class="text-center cadastrar" style="background-color: #efefef">
        ...
        <div class="col-5" style="margin: 10%;">
            <form class="form-signin" action="${pageContext.request.contextPath}/LoginAdmSis" method="POST">
                <img class="mb-4" src="${pageContext.request.contextPath}/css/assets/img/administrador.png" alt="" width="150" height="150">
                <h1 class="h3 mb-3 font-weight-normal">Login Adiministrador</h1>
                <h6 class=" mb-3 font-weight-normal" style="color: #000"><b>${mensagem}</b></h6>

                <label for="inputEmail" class="sr-only">Usuario</label>
                <input type="text" class="form-control m-3" style="color:black;" placeholder="Login" name="loginAdmsis" required autofocus>
                <label for="inputPassword" class="sr-only">Senha</label>
                <input type="password" id="inputPassword" class="form-control m-3" style="color:black;"  placeholder="Senha"  name="senhaAdmsis" required>
                <div class="checkbox mb-3">
                    <label>
                        <a href="${pageContext.request.contextPath}/adm/cadastraradmsis.jsp">
                            Cadastres-se aqui!
                        </a>
                    </label>
                </div>
                ...
                <button class="btn btn-lg btn-primary btn-block m-3" type="submit">Sign in</button>
