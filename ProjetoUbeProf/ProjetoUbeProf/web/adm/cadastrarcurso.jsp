                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            <h4 class="card-title">Nova Curso</h4>
                            <h4 class="card-title">${mensagemadm}</h4>
                            <h5 class="card-subtitle">Insira as Informaçoes Curso.</h5>
                            <form class="form-horizontal mt-4" action="${pageContext.request.contextPath}/CadastrarCurso" method="POST">
                                <div class="form-group">
                                    <label>Nome:</label>
                                    <input type="text" class="form-control"  placeholder="Nome" name="nomeCurso">
                                </div>
                                <br>
                                <div class="col-md-6">
                                    <label for="inputEmail4" class="form-label">Area</label>
                                    <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="idArea">
                                ...
                                <div class="my-3">
                                    <button style="color: white; background-color: black" class="btn btn-dark form-control-submit-button" type="submit" >Criar nova Curso</button>
                                </div>
                            </form>
                        </div>
                    </div>
