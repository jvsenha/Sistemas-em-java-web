                        ...
                        <div class="col-lg-8 col-xlg-9">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal form-material mx-2" name="alteraradministrador" action="AlterarAdm" method="POST" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="Nome" class="form-control form-control-line" value="${administrador.nomeUsuario}"  name="nomeadmin" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="email" placeholder="Email" class="form-control form-control-line" value="${administrador.emailUsuario}" name="emailadmin" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="Senha" class="form-control form-control-line" value="${administrador.senhaUsuario}" name="senhaadmin" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="Login" class="form-control form-control-line" value="${administrador.loginUsuario}"  name="loginadmin" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="17988352523" class="form-control form-control-line" value="${administrador.telefoneUsuario}" name="telefoneadmin" >
                                            </div>
                                        </div>
