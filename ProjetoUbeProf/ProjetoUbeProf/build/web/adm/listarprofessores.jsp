                                ...
                                <h4 class="card-title">${msgLp}</h4>
                                            ...
                                            <table class="table">
                                                ...
                                                <c:forEach var="professor" items="${professores}">
                                                    <tr>
                                                        <th align="center">${professor.idProfessor}</th>
                                                        <th align="center">${professor.nomeUsuario}</th>
                                                        <th align="center">${professor.emailUsuario}</th>
                                                        <th align="center">${professor.loginUsuario}</th>
                                                        <th align="center"> <c:choose>
                                                        <c:when test="${professor.statusUsuario=='1'}">
                                                        ...
                                                        <th align="center">${professor.tipoUsuario}</th>
                                                        <th align="center">
                                                            <c:choose>
                                                                <c:when test="${professor.statusUsuario=='1'}">
                                                                    <a href="InativarProfessor?idUsuario=${professor.idUsuario}" style=" border-radius: 0.25rem; border: 1px solid transparent;" class="btn-danger"> Desativar</a>
                                                                    <br />
                                                                </c:when>    
                                                                <c:otherwise>
                                                                    <a  href="AtivarProfessor?idUsuario=${professor.idUsuario}" style=" border-radius: 0.25rem; border: 1px solid transparent; width:80px; " class="btn-success" > ativar</a>
                                                                    <br />
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </th>
