                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <h5 class="card-subtitle">Insira o nome desta área.</h5>
                            <form class="form-horizontal mt-4" action="${pageContext.request.contextPath}/CadastrarArea" method="POST">
                                <div class="form-group">
                                    <label>Nome:</label>
                                    <input type="text" class="form-control"  placeholder="Nome" name="nomeArea">
                                </div>
                                <div class="my-3">
                                    <button style="color: white; background-color: black" class="btn btn-dark form-control-submit-button" type="submit" >Criar nova Área</button>
                                </div>
                            </form>
                        </div>
                    </div>
