    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (dao.inativar(cliente)) {
                    msgLc = "Cliente inativado com sucesso.";
                    request.setAttribute("msgLc", msgLc);
                    request.getRequestDispatcher("ListarCliente").forward(request, response);
                } else {
                    msgLc = "Problemas ao inativar Cliente.";
                    request.setAttribute("msgLc", msgLc);
                    request.getRequestDispatcher("ListarCleinte").forward(request, response);
                }
            } catch (Exception e) {
