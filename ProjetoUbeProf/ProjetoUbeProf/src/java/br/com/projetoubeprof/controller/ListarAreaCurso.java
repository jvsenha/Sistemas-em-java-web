 ...
 * @author joaos
 */
@WebServlet(name = "ListarAreaCurso", urlPatterns = {"/ListarAreaCurso"})
public class ListarAreaCurso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("adm/listarareacurso.jsp").forward(request, response);
        } catch (Exception ex) {
