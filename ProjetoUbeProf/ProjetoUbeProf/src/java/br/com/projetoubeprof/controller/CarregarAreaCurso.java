 ...
 * @author joaos
 */
@WebServlet(name = "CarregarArea", urlPatterns = {"/CarregarArea"})
public class CarregarAreaCurso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            try {
                ...
                System.out.println("Problemas ao listar os dados das areas! Erro: " + ex.getMessage());
            }
        }
    }
