 ...
 * @author AlunoRemoto
 */
@WebServlet(name = "InativarProfessor", urlPatterns = {"/InativarProfessor"})
public class InativarProfessor extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (dao.inativar(professor)) {
                    msgLp = "Professor inativado com sucesso.";
