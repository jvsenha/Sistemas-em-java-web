 ...
 * @author joaos
 */
@WebServlet(name = "CadastrarArea", urlPatterns = {"/CadastrarArea"})
public class CadastrarArea extends HttpServlet {
            ...
            Area area = new Area();
             area.setNomeArea(nomeArea);
               ...
               try {
                    ...
                    if (dao.cadastrar(area)) {
                        mensagemadm = "Area cadastrada com sucesso!";
                    ...
                    request.getRequestDispatcher("homeadm.jsp").forward(request, response);
                     ...
                     request.setAttribute("mensagemadm", mensagemadm);
                    request.getRequestDispatcher("adm/cadastrararea.jsp").forward(request, response);
