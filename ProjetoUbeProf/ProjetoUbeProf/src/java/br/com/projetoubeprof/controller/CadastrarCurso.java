    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            Curso curso = new Curso();
             ...
             curso.setAreaCurso(new Area(idArea));
    
               try {
                    CursoDAOImpl dao = new CursoDAOImpl();
                    if (dao.cadastrar(curso)) {
                        mensagemadm = "Curso cadastrado com sucesso!";
                        request.setAttribute("mensagemadm", mensagemadm);
                    request.getRequestDispatcher("ListarAreaCursoAdm").forward(request, response);
              
                    } else {
                        mensagemadm = "Problemas ao cadastrar Area. "
